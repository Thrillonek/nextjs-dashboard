		...
		<div className='md:col-span-4 w-full'>
			...
			<div className='bg-gray-50 p-4 rounded-xl'>
				<div className='items-end gap-2 md:gap-4 grid grid-cols-12 sm:grid-cols-13 bg-white mt-0 p-4 rounded-md'>
					<div className='hidden sm:flex flex-col justify-between mb-6 text-gray-400 text-sm' style={{ height: `${chartHeight}px` }}>
					...
					{revenue.map((month) => (
						<div key={month.month} className='flex flex-col items-center gap-2'>
							...
							></div>
							<p className='text-gray-400 text-sm -rotate-90 sm:rotate-0'>{month.month}</p>
						</div>
					))}
				</div>
